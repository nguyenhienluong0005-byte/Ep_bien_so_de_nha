...
export default function Contact() {
  ...
  const FACEBOOK_URL =
    "https://www.facebook.com/share/17Y8cWR9aF/?mibextid=wwXIfr";
  const TIKTOK_URL =
    "https://www.tiktok.com/@epbiensodenhat?_r=1&_t=ZS-925uZL23U5o";
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 md:py-28">
        ...
        >
          ...
          <p className="mt-5 text-sm md:text-base text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Dịch vụ ép & phục hồi biển số chuyên nghiệp – nhanh chóng – chuẩn quy
            định Bộ GTVT.
          </p>
          ...
          <div className="mt-7 flex flex-wrap items-center justify-center gap-3">
            ...
            <a
              ...
              className="inline-flex items-center justify-center rounded-full border border-white/20 bg-white/0 text-white px-5 py-3 text-sm font-semibold hover:bg-white/10 transition"
            >
              <span className="mr-2 font-black text-sky-300">Z</span>
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-slate-800/85 to-slate-900/85 backdrop-blur-xl border border-blue-500/20 rounded-3xl p-7 hover:border-blue-400/40 transition-all duration-500 h-full">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Bấm vào các nút bên dưới để mở Facebook / Zalo / TikTok của Đệ Nhất.
                </p>
                ...
                <div className="mt-5 grid grid-cols-3 gap-3 w-full max-w-xs">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 rounded-xl bg-white/5 border border-white/10 py-3 hover:bg-white/10 transition"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 rounded-xl bg-white/5 border border-white/10 py-3 hover:bg-white/10 transition"
                  >
                    <span className="text-sky-400 text-sm font-black">Z</span>
                ...
                <div className="mt-5 inline-flex items-center gap-2 text-xs text-gray-400">
                  ...
                  Nhắn tin / theo dõi để nhận ưu đãi
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm md:text-base mt-2">
              Bấm “Mở Google Maps” để đi đường nhanh, hoặc xem trực tiếp tại đây.
            </p>
          </div>
        ...
        >
          ...
          <p className="text-gray-400 text-xs md:text-sm max-w-2xl mx-auto leading-relaxed">
            © 2025{" "}
            <span className="font-semibold text-amber-300">ÉP BIỂN SỐ ĐỆ NHẤT</span>{" "}
